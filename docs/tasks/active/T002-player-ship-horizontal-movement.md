...
- **In scope:**
  ...
  - A minimal visible placeholder ship shape suitable for screenshots.
...
- Use simple Godot-native 2D nodes or drawing code for the placeholder ship. Do not add raster art or gameplay systems in this task.
