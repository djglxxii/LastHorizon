...
- **Active:** none
- **Blocked:** none
- **Next proposed:** T016 — Brief post-hit invulnerability
...
| T003 | Auto-fire pea shooter | completed | T002 | video/screens + event log |
...
| T015 | Collision interception model | completed | T014, T021 | video/screens + event log |
